...
class TestQiime2MetadataMaker(BaseTestCase):
    ...
    def test_importer(self):
        ...
        self.assertEqual(list(t1['forward-absolute-filepath']), list(t2['forward-absolute-filepath']))
        self.assertEqual(list(t1['reverse-absolute-filepath']), list(t2['reverse-absolute-filepath']))
