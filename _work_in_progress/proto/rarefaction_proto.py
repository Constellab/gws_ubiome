...
class Qiime2RarefactionProto(Protocol):
    ...
    def configure_protocol(self, config_params: ConfigParams) -> None:
        ...
        input_folder_source: ProcessSpec = self.add_process(Source, 'feature_frequency_folder_source')
        ...
        self.add_connectors([
            (input_folder_source >> "resource", qiime2_rarefaction << "feature_frequency_folder"),
