...
from ..metabarcoding.qiime2_taxonomy_diversity_extraction import Qiime2TaxonomyDiversityExtractor
...
class Qiime2TaxoProto(Protocol):
    ...
    def configure_protocol(self, config_params: ConfigParams) -> None:
        ...
        qiime2_taxo_diversity: ProcessSpec = self.add_process(Qiime2TaxonomyDiversityExtractor, 'qiime2_taxonomy')
        result_folder_sink: ProcessSpec = self.add_process(Sink, 'result_folder_sink')

        self.add_connectors([
            (input_folder_source >> "resource", qiime2_taxo_diversity << "rarefaction_analysis_result_folder"),
