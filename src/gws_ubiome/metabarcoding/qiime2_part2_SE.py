...
@task_decorator("Qiime2PartTwoSE")
class Qiime2PartTwoSE(Qiime2EnvTask):
    """
    ...
    config_specs = {
        ...
        "trunc": IntParam(short_description="Size after truncated forward reads ")
    }
    ...
    def build_command(self, params: ConfigParams, inputs: TaskInputs) -> list:   
        ...
        cmd = [ 
            " bash ", 
            os.path.join(script_file_dir, "./sh/qiime2_part2_SE_cmd.sh"),      
            fastq_folder.path, 
            meta_data.path,
            barcode_colname,
            proj_id,
