...
class Qiime2TaxonomyDiversityExtractor(Task):
    ...
    **About GreenGenes:**
    ...
    DB_GREENGENES_LOCATION = "https://storage.gra.cloud.ovh.net/v1/AUTH_a0286631d7b24afba3f3cdebed2992aa/opendata/ubiome/qiime2/gg-13-8-99-nb-classifier.qza"
    DB_GREENGENES_DESTINATION = "gg-13-8-99-nb-classifier.qza"
    ...
    def run(self, params: ConfigParams, inputs: TaskInputs) -> TaskOutputs:
        ...
        file_downloader = TaskFileDownloader(
            Qiime2TaxonomyDiversityExtractor.get_brick_name(),
            self.message_dispatcher)
        # download a file
        db_file_path = file_downloader.download_file_if_missing(
            self.DB_GREENGENES_LOCATION, self.DB_GREENGENES_DESTINATION)
